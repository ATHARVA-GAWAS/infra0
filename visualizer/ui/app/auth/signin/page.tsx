...
function SignInContent() {
  ...
  const handleSignIn = async (
    provider: Provider,
    metaData: GoogleOAuthLoginPayload | EmailLoginPayload
  ) => {
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">
              Sign in to your account to continue building infrastructure
            </p>
          </div>
          ...
          <div className="space-y-4">
            {/* Google Sign In */}
            <GoogleLoginButton
              handleGoogleSuccess={(metadata: GoogleOAuthLoginPayload) =>
                handleSignIn(Provider.GOOGLE, metadata)
              }
              handleGoogleFailure={() => {}}
            />
            {/* GitHub Sign In */}
